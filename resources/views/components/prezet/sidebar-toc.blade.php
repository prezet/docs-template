...
>
    <button
        class="flex cursor-pointer items-center space-x-2 font-medium text-gray-700 transition-colors hover:text-gray-900 dark:text-gray-200 dark:hover:text-gray-100"
        type="button"
    ...
    >
        <svg
            ...
            class="h-3 w-3 lucide lucide-text-align-start-icon lucide-text-align-start"
        >
            <path d="M21 5H3"/>
            <path d="M15 12H3"/>
            <path d="M17 19H3"/>
    ...
    <ul class="toc">
        @foreach ($headings as $h2)
            ...
            >
                <a
                    href="#{{ $h2['id'] }}"
                    class="block py-1 hover:text-gray-900 dark:text-gray-200 dark:hover:text-gray-100"
            ...
            @foreach ($h2['children'] as $h3)
                <li class="toc-item relative">
                    <a
                        href="#{{ $h3['id'] }}"
                        class="group flex items-start py-1 pl-4 text-gray-500 hover:text-gray-900 dark:text-gray-200 dark:hover:text-gray-100"
